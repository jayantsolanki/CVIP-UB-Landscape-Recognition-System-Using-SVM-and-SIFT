...
% Creates vision.mat. Generates training features for all of the training images.
    ...
    % k=dictionarySize*((4^(3)-1)/3); %dimension of the resultant histogram vector after the histogram vectors for each layer is calculated. for level 3
    k=dictionarySize*((4^(4)-1)/3); %dimension of the resultant histogram vector after the histogram vectors for each layer is calculated, for level 4
	...
	for i=1:T
	    ...
	    train_features(:,i)=getImageFeaturesSPM4(4,wordMap,dictionarySize);
